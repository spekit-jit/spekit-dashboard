document.addEventListener('DOMContentLoaded', function () {
  ...
  const modules = [
    ...
    },
    {
      ...
      html: '<ol class="list-decimal pl-5 text-gray-700 text-sm"><li>Contact Management</li><li>Opportunity Overview</li><li>Duplicate Review Process</li><li>Program Enrollment Status</li><li>Updating Contact Info</li></ol>'
    },
    {
